class Constants {
  ...
  static const String middlewareUrl = 'https://uat.aksmobile.singpost.com/one-login/auth';

  // Web Auth URLs - using localhost:4200
  static const String webAuthUrl = 'https://uat.aksmobile.singpost.com/one-login/auth';
